const Pricing = () => {
  return (
    <>
      <main className="mx-auto pt-10 pb-36 px-8">
        <div className="max-w-md mx-auto mb-14 text-center">
          <h1 className="text-4xl font-semibold mb-6 lg:text-5xl">
            <span className="text-indigo-600">Start Swapping </span> Today
          </h1>
          <p className="text-xl text-gray-500 font-medium">
          Choose a plan that works best for you and your wardrobe.
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 justify-center lg:justify-between items-center lg:items-start">
