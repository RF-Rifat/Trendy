const SpecialOffer = () => {
  return (
    <div className="bg-gradient-to-r from-indigo-300 to-light-blue-300 text-white p-8 rounded-lg shadow-lg max-w-7xlxl mx-auto">
      ...
      <div className="bg-white text-gray-800 rounded-lg px-4 py-2 flex items-center justify-between">
        <span className="text-2xl font-semibold">Trendy</span>
